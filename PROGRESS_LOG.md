...
**Assets:** plugins on release `pcengine-plugin-610`: `-catalog`(ee4bae17), `-singlestream`(9c4c357e, broke), `-seq`(69d5ee71, broke), `-r2`(30919ec3, genuine dl, R2), `-h1`(5c1c8659, CCE-broken), `-h1b`(building) + `-v6`/`-genuine`. pre21 host APK = run `30563299122`/`b4327487` (unaffected — all fixes are plugin+Worker side). Worker rollbacks staged under `worker-backups/`.
